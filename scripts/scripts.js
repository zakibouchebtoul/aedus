  ...
  (p.ClassBody = function () {
    ...
    (p.ClassNavMenu = function () {
      p.BreakClass("." + r, u.lg, { timeOut: 0 }),
        ...
        c.on("resize", function () {
          p.BreakClass("." + r, u.lg),
            p.BreakClass("." + d, u.lg, { classAdd: t });
        });
    }),
    (p.Prettify = function () {
    ...
    (p.TGL.content = function (e, t) {
      ...
      p.TGL.screen(n),
        e.on("click", function (e) {
          (s = this),
            p.Toggle.trigger(x(this).data("target"), r),
            e.preventDefault();
        }),
    ...
    (p.TGL.ddmenu = function (e, t) {
      var e = e || ".nk-menu-toggle",
        ...
        a = t ? f(n, t) : n;
      x(e).on("click", function (e) {
        (p.Win.width < u.lg || x(this).parents().hasClass(d)) &&
    ...
    (p.TGL.showmenu = function (e, t) {
      ...
      n.on("click", function (e) {
        ...
        c.on("resize", function () {
          (p.Win.width < u.xl || p.Win.width < i) &&
            !p.State.isMobile &&
            p.Toggle.removed(n.data("target"), o);
        });
    }),
      ...
      x(e).exists() &&
        x(e).each(function () {
          var e = x(this).data("auto-responsive"),
            ...
            n = s ? f(i, s) : i,
            n = !1 === e ? f(n, { responsive: !1, autoWidth: !1 }) : n;
    ...
    (p.Tagify = function (e, t) {
      x(e).exists() &&
        ...
        ((t = t ? f(void 0, t) : void 0), x(e).tagify(t));
    }),
