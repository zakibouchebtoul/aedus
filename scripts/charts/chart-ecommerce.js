      ...
      datasets: [
        {
          label: "User",
          color: "#465FFF",
          background: NioApp.hexRGB("#465FFF", 0.25),
          data: [
      ...
      datasets: [
        {
          label: "Orders",
          color: "#3fbd9a",
          background: NioApp.hexRGB("#3fbd9a", 0.25),
          data: [
      ...
      datasets: [
        {
          label: "Customers",
          color: "#008080",
          background: NioApp.hexRGB("#008080", 0.25),
          data: [
...
function ecommerceLineS3(selector, set_data) {
  ...
  $selector.each(function () {
    ...
    // Get the data - check if it exists first
    var _get_data;
    try {
      _get_data = void 0 === set_data ? eval(_self_id) : set_data;
    } catch (e) {
      console.error("Data not found for chart: " + _self_id, e);
      return;
    }
    
    // Check if data is valid
    if (!_get_data || !_get_data.datasets) {
      console.error("Invalid data for chart: " + _self_id);
      return;
    }
    ...
    datasets: [
      {
        ...
        color: "#465FFF",
        dash: [0, 0],
        background: NioApp.hexRGB("#465FFF", 0.05),
        data: [
  ...
  background: "transparent",
  data: [
    50, 120, 400, 250, 300, 350, 320, 410, 290, 330, 390, 450, 60, 400,
    500, 420, 480, 220, 470, 0, 100, 120, 450, 500, 150, 100, 130, 300,
    480, 350
  ]
}
  ...
  var trafficSources = {
      ...
      datasets: [
        {
          borderColor: "#fff",
          background: ["#465FFF", "#e85347", "#ffa9ce", "#f9db7b"],
    ...
    orderStatistics = {
      ...
      datasets: [
        {
          borderColor: "#fff",
          background: ["#465FFF", "#e85347", "#0fac81"],
          data: [4305, 259, 682],
        },
      ],
    };
